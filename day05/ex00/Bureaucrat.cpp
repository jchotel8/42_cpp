...
Bureaucrat::Bureaucrat(std::string name)
{
	_name = name;
    _grade = 150;
    std::cout << "[" << _grade << ", "<< _name << "] is born!" << std::endl;
}
...
{
	std::cout << "[" << _grade << ", "<< _name << "] is dead, you won't notice" << std::endl;
	return ;
}
...
{
	out << "[" << b.getGrade() << ", " << b.getName() << "] I'm just a regular degular shmeglar bureaucrat..." << std::endl;
	return (out);
}
